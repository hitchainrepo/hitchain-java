...
public class TransactionExecutionSummary {
    ...
    public TransactionExecutionSummary(org.ethereum.core.Transaction transaction) {
        this.tx = transaction;
    ...
    public void rlpParse() {
        ...
        this.tx = new org.ethereum.core.Transaction(summary.get(0).getRLPData());
    ...
    public static Builder builderFor(org.ethereum.core.Transaction transaction) {
    ...
    public static class Builder {
        ...
        public Builder touchedStorage(Map<DataWord, DataWord> touched, Map<DataWord, DataWord> changed) {
            //TODO summary.touchedStorage.addReading(touched);
            //TODO summary.touchedStorage.addWriting(changed);
            return this;
        }
