...
public interface Repository extends org.ethereum.facade.Repository{
     ...
     */
    org.ethereum.core.AccountState createAccount(byte[] addr);
     ...
     */
    org.ethereum.core.AccountState getAccountState(byte[] addr);
    ...
    void updateBatch(HashMap<ByteArrayWrapper, org.ethereum.core.AccountState> accountStates,
