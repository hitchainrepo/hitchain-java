...
public class TransactionReceipt {
    ...
    private org.ethereum.core.Transaction transaction;

    private byte[] postTxState = EMPTY_BYTE_ARRAY;
    private byte[] cumulativeGas = EMPTY_BYTE_ARRAY;
    private org.ethereum.core.Bloom bloomFilter = new org.ethereum.core.Bloom();
    ...
    public TransactionReceipt(byte[] rlp) {
        ...
        bloomFilter = new org.ethereum.core.Bloom(bloomRLP.getRLPData());
    ...
    public TransactionReceipt(byte[] postTxState, byte[] cumulativeGas,
                              org.ethereum.core.Bloom bloomFilter, List<LogInfo> logInfoList) {
    ...
    public TransactionReceipt(final RLPList rlpList) {
        ...
        this.bloomFilter = new org.ethereum.core.Bloom(rlpList.get(2).getRLPData());
    ...
    public org.ethereum.core.Bloom getBloomFilter() {
        return bloomFilter;
    }
    ...
    public void setTransaction(org.ethereum.core.Transaction transaction) {
        this.transaction = transaction;
    }

    public org.ethereum.core.Transaction getTransaction() {
